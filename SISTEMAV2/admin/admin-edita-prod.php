...
$id=$_GET['id'];
  $host="sql312.260mb.net";
    ...
    $sql ="SELECT * FROM Empleado WHERE DOC =$id";
			...
			<ul class="list-unstyled full-box dashboard-sideBar-Menu">
				...
				<li>
					...
					<ul class="list-unstyled full-box">
						<li>
							<a href="company.html"><i class="zmdi zmdi-balance zmdi-hc-fw"></i> Inventario</a>
						</li>
						<li>
						...
						<li>
							<a href="book.html"><i class="zmdi zmdi-book zmdi-hc-fw"></i> Reservas</a>
						</li>
					</ul>
				</li>
				<li>
			...
			<ul class="breadcrumb breadcrumb-tabs">
                <li>
			  		<a href="admin.html" class="btn btn-info">
			  			<i class="zmdi zmdi-plus"></i> &nbsp; INVENTARIO
			  		</a>
			  	</li>
                  <li>
			  		<a href="admin.html" class="btn btn-info">
				...
				<div class="panel-body">
                    ...
                    while($fila=mysqli_fetch_assoc($sqlquery)){
                        ?>
                            ...
                            <?php } ?>
                            <tr>
                            <form action="editaProd.php?id=<?php echo  $fila['DOC']?>" method="post" >
									<td><input type="text" name="doc" placeholder="ingrese nuevo documento"></td>
                                    <td><input type="text" name="nom1" placeholder="ingrese nuevo nombre"></td>
                                    <td><input type="text" name="nom2" placeholder="ingrese nuevo nombre"></td>
                                    <td><input type="text" name="ape1" placeholder="ingrese nuevo apellido"></td>
                                    <td><input type="text" name="ape2" placeholder="ingrese nuevo apellido"></td>
                                    <td><input type="text" name="tel" placeholder="ingrese nuevo telefono"></td>
                                    <td><input type="text" name="clav" placeholder="ingrese nuevo clave"></td>
                                    <td><input type="text" name="correo" placeholder="ingrese nuevo correo"></td>
                                    <td><input type="text" name="id_tipo" placeholder="ingrese nuevo id_tipo"></td>
