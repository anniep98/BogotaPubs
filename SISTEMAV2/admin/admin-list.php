		...
		<div class="full-box dashboard-sideBar-ct">
			...
			<div class="full-box dashboard-sideBar-UserInfo">
				...
				<ul class="full-box list-unstyled text-center">
					...
					<li>
						<a href="my-account.html" title="Configuracion">
						...
						<table class="table table-hover text-center">
							<thead>
								<tr>
                                    ...
                                    <th class="text-center">ID_TIPO</th>
							...
							<form action="elimina.php?dato=<?php echo $fila['DOC']?>" method="POST">
								<tr>
									...
									<td>
										...
										<a href="admin-edita-prod.php?id=<?php echo $fila['DOC']?>" class="btn btn-success btn-raised btn-xs">
