...
<body>
			...
			<ul class="list-unstyled full-box dashboard-sideBar-Menu">
				...
				<li>
					...
					<ul class="list-unstyled full-box">
						...
						<li>
							<a href="adminpage2.php"><i class="zmdi zmdi-truck zmdi-hc-fw"></i> Proveedores</a>
						</li>
	...
	<section class="full-box dashboard-contentPage">
		...
		<div class="container-fluid">
			...
			<p class="lead">Plataforma de gestionamiento de información</p>
		</div>

		<div class="container-fluid">
			<ul class="breadcrumb breadcrumb-tabs">
                <li>
			  		<a href="adminpage2.php" class="btn btn-info">
			  	...
			  	<li>
                          ...
                          <i class="zmdi zmdi-search"><input type="submit" class="btn btn-success btn-raised btn-xs" value="BUSCAR"></i> 
			  		</a>
			  	</li>
			</ul>
		</div>
				...
				<div class="panel-body">
                    ...
                    while($fila=mysqli_fetch_assoc($sqlquery)){
                        ?>
								...
								<tr>
								<form action="elimina.php?dato=<?php echo $fila['DOC']?>" method="POST">
									...
									<td>
										<a href="editar.php?valor=<?php echo $fila['DOC']?>" class="btn btn-success btn-raised btn-xs">
											enviar<i class="zmdi zmdi-refresh"></i>
										</a>
									</td>
