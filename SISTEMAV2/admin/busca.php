...
$host="sql312.260mb.net";
    ...
    $sql ="SELECT * FROM Empleado WHERE nom_usu LIKE '%$nombre%' ";
    ...
    if($row==1){
      ...
      $mensaje="";
        ...
        $mensaje="No se encontraron resultados para: ".$nombre;
    }
...
<body>
			...
			<ul class="list-unstyled full-box dashboard-sideBar-Menu">
				...
				<li>
					...
					<ul class="list-unstyled full-box">
						<li>
							<a href="admin-list-Productos.php"><i class="zmdi zmdi-labels zmdi-hc-fw"></i> Productos</a>
						</li>
						<li>
	...
	<section class="full-box dashboard-contentPage">
		...
		<div class="container-fluid">
			...
			<p class="lead">Plataforma de gestionamiento de informacion</p>
		</div>

		<div class="container-fluid">
			<ul class="breadcrumb breadcrumb-tabs">
                  <li>
			  		<a href="admin-list-Productos.php" class="btn btn-info">
			  	...
			  	<li>
                          ...
                          <i class="zmdi zmdi-search"><input type="submit" value="BUSCAR EMPLEADO"></i>
			  		</a>
			  	</li>
			</ul>
		</div>
                    ...
                    while($fila=mysqli_fetch_assoc($sqlquery)){
                        ?>
								...
								<form action="elimina.php?dato=<?php echo $fila['DOC']?>" method="POST">
									...
									<td>
										<a href="admin-edita.php?valor=<?php echo $fila['DOC']?>" class="btn btn-success btn-raised btn-xs">
