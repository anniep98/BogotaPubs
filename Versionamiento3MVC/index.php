...
<form action="controlador/ControladorIndex.php" method="POST" class="login-form">
     <div class="form-group">
                    <label for="exampleInputEmail1" class="text-uppercase">Usuario</label>
                    <input type="text" class="form-control" id="nombre" name="usuario" placeholder="Ingrese su usuario">
        ...
        <div class="form-check">
                ...
                <button type="submit" name="login" class="btn btn-login float">INICIAR SESIÓN</button>
                
            </form>
             <br><br>
	        <i ></i> ¿No tienes cuenta aún? <a href='vista/FormRegistro.php'>Regístrate</a><br>
                	
                    <i ></i> ¿Se te olvidó tu contraseña? <a href='vista/FormRecuperarClave.php'>Recuperar</a>
...
<div class="copy-text">Creado  <i class="fa fa-heart"></i> por<a href="https://www.facebook.com/anamaria.pescapedraza"> Ana Maria Pedraza y Miguel Bautista</a></div>
		</div>
